SELECT [sJOB].[job_id] AS [JobID]
     ...
     , CASE [sJSTP].[on_success_action]
           ...
           WHEN 4
           THEN 'Go to Step: ' + QUOTENAME(CAST([sJSTP].[on_success_step_id] AS VARCHAR(3))) + ' ' + [sOSSTP].[step_name]
     ...
     , CASE [sJSTP].[on_fail_action]
           ...
           THEN 'Go to the next step'
           WHEN 4
           THEN 'Go to Step: ' + QUOTENAME(CAST([sJSTP].[on_fail_step_id] AS VARCHAR(3))) + ' ' + [sOFSTP].[step_name]
